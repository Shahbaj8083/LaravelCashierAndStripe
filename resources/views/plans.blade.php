                    ...
                    <div class="pricing pricing-palden">
                        ...
                        <div class="pricing-item">
                            <div class="pricing-deco l-slategray">
                                ...
                                <div class="pricing-price"><span {{-- class="pricing-currency">£</span>{{ $basic->price / 100 }} --}} class="pricing-currency">£</span>
                            ...
                            {{-- <a href="{{ route('plans.checkout', $basic->plan_id) }}"
                                    class="pricing-action l-amber">Choose plan</a> --}}
                        </div>
                        {{-- @endif --}}
                            ...
                            <div class="pricing-item">
                                <div class="pricing-deco l-slategray">
                                    <svg class="pricing-deco-img" enable-background="new 0 0 300 100" height="100px"
                                        ...
                                        viewBox="0 0 300 100" width="300px" x="0px" xml:space="preserve"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"
                                        y="0px">
                                        <path class="deco-layer deco-layer--1"
                                            d="M30.913,43.944c0,0,42.911-34.464,87.51-14.191c77.31,35.14,113.304-1.952,146.638-4.729&#x000A;	c48.654-4.056,69.94,16.218,69.94,16.218v54.396H30.913V43.944z"
